// ÊÎÐÐÅÊÖÈß TONEMAPPINGA ×ÒÎÁÛ ÌÀÒÅÐÈÀË ÍÅ ÑËÈØÊÎÌ ÁËÅÑÒÅË https://discourse.threejs.org/t/srgb-encoding-as-a-postprocess-pass/12278/15
...
varying vec2 vUv;
uniform vec3 color; // ÖÂÅÒ
uniform float saturation; // ÍÀÑÛÙÅÍÍÎÑÒÜ
uniform float vibrance; // ÐÅÇÎÍÀÍÑÍÛÉ ÖÂÅÒ
uniform float gamma; // ÃÀÌÌÀ
uniform float brightness; // ßÐÊÎÑÒÜ
uniform float contrast; // ÊÎÍÒÐÀÑÒÍÎÑÒÜ
...
// ÊÓÑÎÊ ÊÎÄÀ ÈÇ GammaCorrectionShader, Ò.Å. ÔÓÍÊÖÈß LinearTosRGB ÂÎÇÂÐÀÙÀÅÒ ÍÎÐÌÀËÜÍÓÞ ÃÀÌÌÓ ÄËß renderer.outputEncoding=THREE.sRGBEncoding; ÏÐÈ ÈÑÏÎËÜÇÎÂÀÍÈÈ EffectComposer
